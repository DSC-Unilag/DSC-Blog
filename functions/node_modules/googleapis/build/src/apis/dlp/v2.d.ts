...
export declare namespace dlp_v2 {
    ...
    export class Resource$Locations {
         ...
         * @return {object} Request object
         */
        infoTypes(params?: Params$Resource$Locations$Infotypes, options?: MethodOptions): GaxiosPromise<Schema$GooglePrivacyDlpV2ListInfoTypesResponse>;
        infoTypes(params: Params$Resource$Locations$Infotypes, options: MethodOptions | BodyResponseCallback<Schema$GooglePrivacyDlpV2ListInfoTypesResponse>, callback: BodyResponseCallback<Schema$GooglePrivacyDlpV2ListInfoTypesResponse>): void;
        infoTypes(params: Params$Resource$Locations$Infotypes, callback: BodyResponseCallback<Schema$GooglePrivacyDlpV2ListInfoTypesResponse>): void;
        infoTypes(callback: BodyResponseCallback<Schema$GooglePrivacyDlpV2ListInfoTypesResponse>): void;
    }
    export interface Params$Resource$Locations$Infotypes extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
