...
export declare namespace dfareporting_v3_2 {
    ...
    export interface Params$Resource$Directorysitecontacts$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    export interface Params$Resource$Directorysitecontacts$List extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
